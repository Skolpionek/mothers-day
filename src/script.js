import charming from "https://esm.sh/charming@3.0.2";

let grid_init = document.querySelector(".grid");
let content_init = document.querySelector(".content");
let picAmout = 20;
for(let i=1;i<=picAmout;i++){
	...
	<div class="grid__item-wrap">
		<img class="grid__item-img" src="./img/kot${i}.png" alt="Kot" />
	</div>
	<h3 class="grid__item-title"></h3>
	<h4 class="grid__item-number"><h4 class="grid__item-number"></h4></h4>
	`
	grid_init.appendChild(link);

	const contentItem = document.createElement('div');
	contentItem.className = 'content__item';
	contentItem.innerHTML = `
		<div class="content__item-intro">
			<img class="content__item-img" src="./img/kot${i}.png" alt="Dove" />
			<h2 class="content__item-title"></h2>
		</div>
	`;
	content_init.appendChild(contentItem);
}
